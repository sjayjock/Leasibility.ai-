        ...
        try {
          ...
          for (const s of generatedScenarios) {
            await createScenario({
              ...
              requestedProgram: s.requestedProgram,
              existingConditions: s.existingConditions,
              achievedProgram: s.achievedProgram,
              fitVariance: s.fitVariance,
              reuseStrategy: s.reuseStrategy,
              changeSummary: s.changeSummary,
              qaWarnings: s.qaWarnings,
