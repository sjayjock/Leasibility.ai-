...
export const scenarios = mysqlTable("scenarios", {
  ...
  requestedProgram: json("requestedProgram"),
  existingConditions: json("existingConditions"),
  achievedProgram: json("achievedProgram"),
  fitVariance: json("fitVariance"),
  reuseStrategy: text("reuseStrategy"),
  changeSummary: json("changeSummary"),
  qaWarnings: json("qaWarnings"),
  validationStatus: varchar("validationStatus", { length: 32 }),
